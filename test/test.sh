...
printf $CYAN $ENV_SHOW
printf $CYAN $EXPORT_SHOW
...
# EXIT
printf $CYAN "exit 42"
printf $CYAN "exit 42 53 68"
printf $CYAN "exit 259"
printf $CYAN "exit 9223372036854775807"
printf $CYAN "exit -9223372036854775808"
printf $CYAN "exit 9223372036854775808"
printf $CYAN "exit -9223372036854775810"
printf $CYAN "exit -4"
printf $CYAN "exit wrong"
printf $CYAN "exit wrong_command"
printf $CYAN "gdagadgag"
printf $CYAN "ls -Z"
printf $CYAN "cd gdhahahad"
printf $CYAN "ls -la | wtf"
